...
class MainWindow(QMainWindow):
    ...
    def ruleaza(self):
        ...
        rezultat, erori_abs, erori_rel, nr_iter = self.coarda(
            self.functie, self.a, self.b,
            nr_iteratii_max, epsilon, nr_zecimale
        )
        ...
        if nr_zecimale:
            ...
            mesaj = f"Solutie coarda: {rezultat:.10f}  |  {nr_iter} iteratii{linie_exacta}{avert}"
